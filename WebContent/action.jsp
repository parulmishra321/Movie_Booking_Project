					...
					<h3 class="agile_w3_title hor-t">Comedy<span>Movies</span> </h3>
					 ...
					 <%ArrayList<Movies> allMovies = (ArrayList<Movies>)request.getAttribute("data"); 
										...
										<div class="col-md-2 w3l-movie-gride-agile requested-movies">
															...
															<a href="single.jsp" class="hvr-sweep-to-bottom"><img src="images/<%= m.getM_poster() %>" title="Movies Pro" class="img-responsive" alt=" ">
																<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
															</a>
																<div class="mid-1 agileits_w3layouts_mid_1_home">
																	<div class="w3l-movie-text">
																	<% String mname= m.getM_name(); %>
																	<% System.out.println(mname);
																	
																	%><input type="hidden" value="Avengers:Endgame">
																		<h6><a href="single.jsp?movie_name="+mname > 
																		<%= m.getM_name() %></a></h6>							
																	</div>
